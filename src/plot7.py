...
axs[1].plot(ohlc['Close'].rolling(100, min_periods=2).apply(calc_slope), label="9-Day ROC", color="blue")
axs[2].plot(ohlc['Close'].rolling(200, min_periods=2).apply(calc_slope), label="9-Day ROC", color="black")
